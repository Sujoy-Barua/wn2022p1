...
//REQUIRES: v is not empty
//          p is an integer
//EFFECTS: returns the summation of the deviation of a vector v from its mean 
//m raised to the power of p.
double sumOfDeviation_to_Power (std::vector<double> v, double m, double p);
